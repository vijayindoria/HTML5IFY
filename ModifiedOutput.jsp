  ...
  <icc:windowOnload>
	...
	<div id="div-dialogBody" class="mdDivDialogBody mdDivWidth">
		...
		<div id="div-medicationsIframeContainer" class="mdDivHeight mdDivmedicationsIframeContainer">
				<iframe id="iframeLocationIndCorr" name="iframeLocationIndCorr" class="mdLocMedTitleBarCommon mdScrolling Input49"  src='<sframe:emptyPage/>'></iframe>
